...
export default function PortfolioCard({
  ...
  const cardBody = (
    ...
    >
      ...
      <div className={`relative overflow-hidden border-b border-white/10 bg-gradient-to-br ${theme.surface} ${theme.frame}`}>
        <PortfolioMedia
          src={item.image || null}
          alt={item.title}
          className="p-5 transition-transform duration-700 group-hover:scale-[1.02]"
